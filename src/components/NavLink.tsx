...
export function NavLink({ href, children }: NavLinkProps) {
  ...
  return (
    <Link
      ...
      // text-sm reverts to 14px below the sm breakpoint (see globals.css),
      // which is the size five links were always sized at on phones and is
      // known to fit down to a 320px screen — no separate mobile split needed.
