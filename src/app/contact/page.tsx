...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://tabeen.dev/contact" },
};
    ...
    <div className="max-w-article mx-auto px-6 sm:px-8">
      <section className="py-14">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-muted group-hover:text-accent" aria-hidden="true">
          ...
          <a
            ...
            className="flex items-center gap-3 text-ink py-4 border-b border-line hover:text-accent transition-colors group"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-muted group-hover:text-accent" aria-hidden="true">
