...
TODO(tabeen): write a 2–4 sentence dated update on how your view of AI-assisted coding has evolved now that you work with AI coding agents professionally. Leaving this post unchanged reads as a contradiction with current practice — this placeholder exists so that contradiction doesn't ship silently.
